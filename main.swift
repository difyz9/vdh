...
func printHelp() {
    ...
    print("  config [show|edit|reload|reset] Manage configuration")
    ...
    print("  vdh config show           # Show current settings")
    print("  vdh config edit           # Edit config file")
    print("  vdh config reload         # Reload after editing")
    print("")
    ...
    print("")
    print("CONFIGURATION:")
    print("  Config file: ~/.vdh/config.yaml")
    print("  Database:    ~/.vdh/video_downloader.db")
    print("  Temp files:  ~/.vdh/temp/")
    print("  Default output: ~/Downloads/VideoDownloader/")
    print("")
